					...
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Users </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
								<li><a href="#" onclick="loadAllUserForm()">User List</a></li>
								<li><a href="#" onclick="loadAddUserForm()"> Add User </a></li>
							</ul>
						</li>
						<li class="submenu"> <a href="#"><i class="fas fa-key"></i> <span> Rooms </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
							<li><a href="#" onclick="loadAllRoomForm()"> All Rooms </a></li>
							<li><a href="#" onclick="loadAddRoomForm()"> Add Roons </a></li>
							</ul>
						</li>
